...
class __TwigTemplate_f9062fda6281b93d5bd5031bf2251ab8297ecc52e4e16a262e6edc10eb9e3528 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"block-exception-detected clear-fix\">
        ...
        echo "</strong> ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 17, $this->source); })()), "html", null, true);
        echo " - ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 17, $this->source); })()), "class", [], "any", false, false, false, 17));
        echo "
            </div>

            ";
        // line 20
        $context["previous_count"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 20, $this->source); })()), "allPrevious", [], "any", false, false, false, 20));
        // line 21
        echo "            ";
        if ((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new RuntimeError('Variable "previous_count" does not exist.', 21, $this->source); })())) {
            // line 22
            echo "                <div class=\"linked\"><span><strong>";
            echo twig_escape_filter($this->env, (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new RuntimeError('Variable "previous_count" does not exist.', 22, $this->source); })()), "html", null, true);
            echo "</strong> linked Exception";
            echo ((((isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new RuntimeError('Variable "previous_count" does not exist.', 22, $this->source); })()) > 1)) ? ("s") : (""));
            echo ":</span>
                    <ul>
                        ";
            // line 24
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 24, $this->source); })()), "allPrevious", [], "any", false, false, false, 24));
            foreach ($context['_seq'] as $context["i"] => $context["previous"]) {
                // line 25
                echo "                            <li>
                                ";
                // line 26
                echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, $context["previous"], "class", [], "any", false, false, false, 26));
...
";
        // line 40
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 40, $this->source); })()), "toarray", [], "any", false, false, false, 40));
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 41
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "@Twig/Exception/exception.html.twig", 41)->display(twig_to_array(["exception" => $context["e"], "position" => $context["position"], "count" => (isset($context["previous_count"]) || array_key_exists("previous_count", $context) ? $context["previous_count"] : (function () { throw new RuntimeError('Variable "previous_count" does not exist.', 41, $this->source); })())]));
        }
        $_parent = $context['_parent'];
...
";
        // line 44
        if ((isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 44, $this->source); })())) {
            // line 45
        ...
        <div class=\"logs clear-fix\">
            ...
            ";
            // line 57
            if (twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 57, $this->source); })()), "counterrors", [], "any", false, false, false, 57)) {
                // line 58
                ...
                echo " error";
                echo (((twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 60, $this->source); })()), "counterrors", [], "any", false, false, false, 60) > 1)) ? ("s") : (""));
                echo "
                    </span>
                </div>
            ";
        ...
        <div id=\"logs\">
            ";
            // line 67
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "@Twig/Exception/exception.html.twig", 67)->display(twig_to_array(["logs" => twig_get_attribute($this->env, $this->source, (isset($context["logger"]) || array_key_exists("logger", $context) ? $context["logger"] : (function () { throw new RuntimeError('Variable "logger" does not exist.', 67, $this->source); })()), "logs", [], "any", false, false, false, 67)]));
            // line 68
            echo "        </div>
    </div>
";
...
";
        // line 72
        if ((isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new RuntimeError('Variable "currentContent" does not exist.', 72, $this->source); })())) {
            // line 73
            echo "    <div class=\"block\">
        ";
            // line 74
        ...
        <div id=\"output-content\" style=\"display: none\">
            ";
            // line 85
            echo twig_escape_filter($this->env, (isset($context["currentContent"]) || array_key_exists("currentContent", $context) ? $context["currentContent"] : (function () { throw new RuntimeError('Variable "currentContent" does not exist.', 85, $this->source); })()), "html", null, true);
            echo "
        </div>
...
";
        // line 92
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "@Twig/Exception/exception.html.twig", 92)->display(twig_to_array(["exception" => (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 92, $this->source); })())]));
        // line 93
        echo "
...
";
    ...
    {
        return array (  223 => 93,  221 => 92,  218 => 91,  209 => 85,  205 => 83,  195 => 75,  193 => 74,  190 => 73,  188 => 72,  185 => 71,  180 => 68,  178 => 67,  173 => 64,  164 => 60,  160 => 58,  158 => 57,  155 => 56,  145 => 48,  143 => 47,  139 => 45,  137 => 44,  134 => 43,  127 => 41,  123 => 40,  113 => 32,  108 => 29,  91 => 26,  88 => 25,  84 => 24,  76 => 22,  73 => 21,  71 => 20,  61 => 17,  55 => 14,  40 => 1,);
    }
...
//]]></script>
", "@Twig/Exception/exception.html.twig", "/Applications/MAMP/htdocs/Todolist/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
